...
<?php 
	...
	if(isset($_POST["done"])){
			...
			$field = array('proid','price','price_promo','size');
			...
			$values = array(
							...
							format($_POST["price"],0),
							format($_POST["price_promo"],0),
							format($_POST["size"],0)
							);
...
<div id="center-column">
			<div class="top-bar">
            	<a href="<?php echo loadPage('addprice')."&proid=".$proid; ?>"  class="button">
			...
			<div class="table">
				...
				<table class="listing form" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
						...
						<td colspan="3" class="last"><input name="size" type="text" id="size" style="width:300px" value="<?php echo $row['size']?>"/> </td>
					</tr>
                    <tr>
						<td class="first" width="135"><strong>Giá</strong></td>
						<td colspan="3" class="last">
                        	<!--<input name="price" type="text" id="price" style="width:300px" value="<?php echo $row['price']?>"/>--> 
                    ...
                    <tr>
						...
						<td colspan="3" class="last"><input name="price_promo" type="text" id="price_promo" style="width:300px" value="<?php echo $row['price_promo']?>"/> </td>
					</tr>
					<tr class="bg">
					  <td class="first">&nbsp;</td>
...
<?php
	...
	if(isset($_POST["search"])){
		...
		// loadPaging(&$start,&$nume,$limit=20,$where='',$order='order by id desc');
			if(	isset($_POST["done"]) && $thongbao == 'OK')
				$res = $tbl->loadPaging($start,$nume,$limit,' where proid = '.$proid,' order by price desc');
			else
				$res = $tbl->loadPaging($start,$nume,$limit,' where id <>'.$_GET['id'].' and proid = '.$proid,' order by price desc');
		}
