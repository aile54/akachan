...
<div id="center-column">
			<div class="top-bar">
			<a href="<?php echo loadPage('addsupport'); ?>" class="button"><img src="img/add-folder-icon.png" width="30" height="30" border="0" />  </a>
				<h1>Support</h1>
				<div class="breadcrumbs"><a href="#">Homepage</a> / <a href="#">Support</a></div>
			</div><br />
			<form method="post">
...
<?php
	...
	$pagename = $_SERVER["PHP_SELF"]."?choose=support";
	$limit = 20;
	if(isset($_GET["start"])){
			$start = $_GET["start"];
		}
...
?>
                    <tr>
						<td class="first style1"><a href="<?php echo loadPage('editsupport&id='.$row['id']); ?>"><?php echo $row['name']; ?></a></td>
