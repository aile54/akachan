...
<div id="center-column">
			<div class="top-bar">
				<a href="<?php echo loadPage('addshopping'); ?>"  class="button"><img src="img/add-folder-icon.png" width="30" height="30" border="0" />  </a>
				<h1>Shopping</h1>
			  <div class="breadcrumbs"><a href="#">Homepage</a> / <a href="#">shopping</a></div>
			</div><br />
			<form method="post">
...
<?php
	...
	$pagename = $_SERVER["PHP_SELF"]."?choose=shopping";
	$limit = 20;
	$start = $_GET["start"];
...
?>					
                    <tr>
						<td class="first style1"><a href="<?php echo loadPage('editshopping&id='.$row['id']); ?>"><?php echo $row['name']; ?></a></td>
