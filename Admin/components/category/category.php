...
<div id="center-column">
			<div class="top-bar">
				<a href="<?php echo loadPage('addCategory'); ?>" class="button"><img src="img/add-folder-icon.png" width="30" height="30" border="0" />  </a>
				<h1>Category</h1>
...
<?php
	...
	// get value
	$pagename = $_SERVER["PHP_SELF"]."?choose=category";
	$limit = 20;
	if(isset($_GET["start"])){
			$start = $_GET["start"];
		}
...
?>                    
                    <tr>
						<td class="first style1"><a href="<?php echo loadPage('editCategory&id='.$row['id']); ?>"><?php echo $row['name']; ?></a></td>
