<?php
	if(isset($_POST["done"])){
		...
		if(is_dir('components/'.$_POST['tbl_name_new'])){
			echo "Thư mục đã tồn tại vui lòng chọn tên khác.";
		}
		else{
			mkdir('components/'.$_POST['tbl_name_new'],0777,true);
			chmod('components/'.$_POST['tbl_name_new'],0777);
			/*-----------View------------------*/
    ...
    <div class="table">
        ...
        <table class="listing form" cellpadding="0" cellspacing="0">
            ...
            <tr>
                ...
                <td class="last"><input name="tbl_name_old" type="text" class="text"/></td>
            </tr>
            <tr>
                <td class="first"><strong>Tên table (New)</strong></td>
                <td class="last"><input name="tbl_name_new" type="text" class="text"/></td>
            </tr>
            <tr>
