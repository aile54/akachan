...
<head>
	...
	<script type="text/javascript" src="../Templates/Plugin/share/share.min.js"></script>
	<script type="text/javascript" src="../Templates/Scripts/numeral.min.js"></script>
	 ...
	 */
		...
		function clickAddFavorite($btnAddFavorite, productId)
		{
			var ele = $($btnAddFavorite);
			$.post("../Models/xl_like.php", { productId: productId })
				.done(function(data) {
					//$(".cart-top").html(data);
					...
					{
						ele.addClass("btnAddFavoriteActive")
            ...
            <article class="home">
              ...
              <div id="clearbetween">
                ...
                <!-- InstanceBeginEditable name="Main" -->
					<?php include_once("../Controllers/transport_info.php");?>
                <!-- InstanceEndEditable -->
                <div id="clearbetween">
                </div>
