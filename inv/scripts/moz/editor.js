...
function InnovaEditor(oName)
    ...
    this.btnSave=false;this.btnPreview=true;this.btnFullScreen=true;this.btnPrint=false;this.btnSearch=false;
    ...
    this.btnCut=false;this.btnCopy=false;this.btnPaste=false;this.btnPasteText=false;this.btnUndo=true;this.btnRedo=true;
    ...
    this.arrStyle=[["BODY",false,"","font-family:Tahoma,Arial,Helvetica;font-size:10pt"]];
...
function RENDER(sPreloadHTML)
    ...
    sHTML+="<table id=idArea"+this.oName+" name=idArea"+this.oName+" border='0px' "+
            ...
            "<tr><td colspan=2 style=\"padding:0px;background:url('"+this.scriptPath+"icons/bg.gif')\">"+
            "<table cellpadding=0 cellspacing=0 border=0 width=100% style='padding:0px;boder=0'><tr><td style='padding:0px;boder=0'>"+
            sHTMLIcons+
            "</td></tr></table>"+
            "</td></tr>"+
    ...
    sHTML+="<table cellpadding=0 cellspacing=0 width=100% height=100%><tr><td width=100% style='padding:0px;' height=100%>";//StyleSelect
...
function drawColorPicker()
    ...
    var arrColors=[["#800000","#8b4513","#006400","#2f4f4f","#000080","#4b0082","#800080","#000000"],
                ...
                ["#ffdab9","#fbfbad","#98fb98","#e0ffff","#87cefa","#cdbfdc","#dda0dd","#ffffff"]];
    ...
    for(var i=0;i<arrColors.length;i++)
        ...
        for(var j=0;j<arrColors[i].length;j++)
            sHTMLColor+="<td onclick=\""+this.oName+".color='"+arrColors[i][j]+"';"+this.oName+".onPickColor();"+this.oName+".currColor='"+arrColors[i][j]+"';"+this.oName+".hideAll()\" onmouseover=\"this.style.border='#777777 1px solid'\" onmouseout=\"this.style.border='#E9E8F2 1px solid'\" style=\"padding:0px;cursor:default;padding:1px;border:#E9E8F2 1px solid;\" unselectable=on>"+
                ...
                "<tr><td unselectable=on style='margin:0px;width:13px;height:13px;background:"+arrColors[i][j]+";border:white 1px solid; padding:0px;'></td></tr>"+
                "</table></td>";
        sHTMLColor+="</tr>";        
        }
