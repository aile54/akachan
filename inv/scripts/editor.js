...
function RENDER(sPreloadHTML)
	...
	sHTML+="<table id=idArea"+this.oName+" name=idArea"+this.oName+" border=0 "+
		...
		"<table cellpadding=0 cellspacing=0 width=100% style='padding:0px;boder=0'><tr><td dir=ltr style='padding:0px'>"+
		sHTMLIcons+
		"</td></tr></table>"+
		"</td></tr>"+
	...
	sHTML+="<table cellpadding=0 cellspacing=0 width=100% height=100% style='padding:0px;margin-top:1px;border:solid 1px #cfcfcf'><tr><td width=100% height=100% style='padding:0px'>";//StyleSelect

	sHTML+="<iframe style='width:100%;height:100%;' "+
